<?php
		include("../connexion.php");
			...
			catch (PDOException $e)
			{
				...
				<div class='FormContain'>
					<div class='form'>
						<div class='form-heading'> Ajout Switch </div>
		...
		$requete = sprintf("SELECT C.IdConstructeur, C.Nom FROM constructeur C inner join switch on (C.IdConstructeur = switch.IdConstructeur) group by C.IdConstructeur, C.nom");
		...
		$link = mysqli_connect(serv(),utili(),pass(),bdd()) or die("Error " . mysqli_error($link));
		$requete2 = sprintf("SELECT M.IdModele, M.Nom FROM Modele M inner join switch on (M.IdModele = switch.IdModele) group by M.IdModele, M.nom ");
