<?php
			...
			if($_SESSION["membreid"]=="dsic"){
				...
				echo ("<h1 align='center'>Modification Serveur</h1>");
				echo("<form action='selectserveurmodif.php' method='post'>");
		...
		else
		{
			...
			$link = mysqli_connect(serv(),utili(),pass(),bdd()) or die("Error " . mysqli_error($link));
				...
				$result = mysqli_query($link,$requete);
				echo ("
				<form action='selectserveurmodif.php' method='post'>
					<table>
						<caption> Modification Serveur </caption>
							<thead>
								<tr>
