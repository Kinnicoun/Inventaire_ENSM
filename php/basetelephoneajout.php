<?php
		include("../connexion.php");
			...
			catch (PDOException $e)
			{
				...
				echo("<form action='finajouttelephone.php' method='post'>
				<div class='FormContain'>
					<div class='form'>
						<div class='form-heading'> Ajout Téléphone </div>
		...
		$requete = sprintf("SELECT C.IdConstructeur, C.Nom FROM constructeur C inner join telephone T on (C.IdConstructeur = T.IdConstructeur) group by C.IdConstructeur, C.nom");
		...
		$link = mysqli_connect(serv(),utili(),pass(),bdd()) or die("Error " . mysqli_error($link));
		$requete2 = sprintf("SELECT M.IdModele, M.Nom FROM Modele M inner join telephone T on (M.IdModele = T.IdModele) group by M.IdModele, M.nom ");
